...
{
    internal static class LoggingMessage
    {
        ...
        public static string DeleteFile(string TargetFileName)
        {
            string Message = $"Deleted:\t{TargetFileName}\n";
            return LogMessageFormated(Message);
        }

        public static string CreateDirectory(string TargetDirectoryPath)
        {
            string Message = $"Created:\t{TargetDirectoryPath}\n";
            return LogMessageFormated(Message);
        }
        public static string DeleteDirectory(string TargetDirectoryPath)
        {
